...
def main():
    while True:
        ...
        # Check if the Excel file exists and read its content
        ...
        for anime in anime_list[index - 1:]:
            if anime.has_attr("href") and index % 2 == 0:  # Check if index is divisible by 2
                ...
                # Check if the anime info is empty
                if all(value == '' for value in anime_info.values()):
                    print("Empty anime info encountered, stopping the script.")
